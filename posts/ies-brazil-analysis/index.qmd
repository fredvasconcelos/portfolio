...
De acordo com nossas estimativas, em média 971.7 mil mulheres (sd = 785) e 758.7 mil homens (sd = 598) ingressam anualmente nas IES do país. Pôde-se observar uma tendência de crescimento do número de alunos ao longo dos anos, tanto os do sexo masculino, quanto do feminino (Figure 1; Table 1). 
...
A região com maior crescimento de alunos ao longo dos anos foi o Sudeste (mean = 877,61 K; sd = 595,20 K), seguido por Nordeste ($321.32 \pm 274.42$), Sul ($301.41 \pm 239.46$), Norte ($135.33 \pm 117.40$) e Centro-Oeste ($169.04 \pm 139.36$).
...
O Estado com maior crescimento de alunos ao longo dos anos foi o São Paulo ($553.17 \pm 329.23 K$), seguido por Minas Gerais ($167.92 \pm 128.15 K$) e Rio de Janeiro ($153.61 \pm 115.95 K$) (Figure 3; Table 3).

::: panel-tabset

### Figure 3

```{r, message=FALSE, fig.dim=c(14,10)}
...
Observa-se que entre os anos 2000 e 2008 há um crescimento no número de ingressantes com idade inferior à 18 anos
...
students_2008 %>%
  ...
  geom_vline(xintercept = 2014, linetype = 4, col = 'red', linewidth = 0.8) + 
  geom_vline(xintercept = 2016, linetype = 4, col = 'red', linewidth = 0.8) + 
  ggthemes::scale_fill_ptol() +
  ggthemes::theme_clean() +
  facet_wrap( ~ var, scales = 'free_y') +
  labs(fill = 'Sex',
       linetype = 'Sex',
       caption = 'Figure 4: Growth of new students by age.') +
  theme(plot.caption.position = "plot",
        plot.caption = element_text(hjust = 0)) +
  ylab('Total of new students') +
  xlab('') +
