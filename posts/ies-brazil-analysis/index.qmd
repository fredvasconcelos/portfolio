...
students_2008 %>%
  ...
  column_spec(1:14, background = 'white')
...
```{r, message=FALSE, fig.dim=c(14,12)}
...
students_2008 %>%
  ...
  labs(fill = 'Sex',
       linetype = 'Sex',
       caption = "Figure 4: Growth of new students by age. The red-dashed lines represents the economic crises (2008-09); black-dashed the political has culminating on Dilma Roussef's impeachment (2014-16); and the red-solid the COVID-19 pandemic.") +
  theme(plot.caption.position = "plot",
        plot.caption = element_text(hjust = 0)) +
  ylab('Total of new students') +
  xlab('') +
